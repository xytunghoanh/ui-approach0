...
<script>
import icon_akamai from './resource/akamai-logo-white.png'
import icon_mse from './resource/mse.png'
import icon_aops from './resource/aops.png'
...
export default {
  ...
  methods: {
    onClick(elem) {
      ...
      /* Social Medium */
      case 'email':
        window.location.href = 'mailto:clock126@126.com'
        break
      case 'github':
