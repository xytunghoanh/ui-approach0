// server.js - Unified static file & relay backend server powered by Bun.serve
...
const server = Bun.serve({
  port: PORT,
  async fetch(req) {
    // 1. Handle API relay requests (search-relay, click-relay)
...
console.log(`[ui-approach0] Bun unified server running at http://localhost:${server.port}`);
